...
В соответствии с топологией, настроил рабочее пространство ([рис. @fig-001]):

![Топология IPv4](image/1.png){#fig-001 width=70%}

На маршрутизаторе изменил имя устройства, доменное имя и заменил системного пользователя ([рис. @fig-002]):
...
После настроил адресацию IPv4 и добавил конфигурацию DHCP-сервера ([рис. @fig-003]):
...
После настроил узел ([рис. @fig-004]):
...
Проверил конфигурацию IPv4 и пропинговал маршрутизатор ([рис. @fig-005]):
...
Далее проверил захваченные пакеты ([рис. @fig-006]):
